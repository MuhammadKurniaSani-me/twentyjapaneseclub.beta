...
<head>
    ...
    <link rel="stylesheet" href="../../../stylesheets/student_sign_up.css">
...
<body>
    ...
    <main>
        ...
        <section class="form sections">
            <h1>Daftar Sebagai Pelajar</h1>
            <p>Sudah memiliki akun? <a id="sign-up" href="./student_sign_in.php">Masuk!</a></p>
            <form class="forms-container" name="form_sign_up" action="./student_sign_in.php" method="POST" onsubmit="">
                <div class="input-container">
                    ...
                    <div class="student-class-container">
                        <div class="class-label-container">
                            <h4>
                                Kelas
                            </h4>
                        </div>
                        <div class="class-input-box">
                            <div class="class dropdown">
                                <p class="label-dropdown">Kelas</p>
                                <figure class="arrow-container">
                                    <img class="arrow" src="../../../images/icons/arrow.svg" alt="Arrow">
                                </figure>
                            ...
                            <div class="field dropdown">
                                <p class="label-dropdown">Jurusan</p>
                                <figure class="arrow-container">
                                    <img class="arrow" src="../../../images/icons/arrow.svg" alt="Arrow">
                                </figure>
                                <ul class="dropdown-content">
                            ...
                            <div class="class-id dropdown">
                                <p class="label-dropdown">Nomor</p>
                                <figure class="arrow-container">
                                    <img class="arrow" src="../../../images/icons/arrow.svg" alt="Arrow">
                                </figure>
                                <ul class="dropdown-content">
